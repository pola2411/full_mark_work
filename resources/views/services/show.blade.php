...
<div class="fav">
    <a href="favourite.html"><span><img src="{{asset('front/images/icons/heart-svgrepo-com.svg')}}" alt="chat" /></span></a>
</div>
<div class="socialicons">
    <a href=""><span><img src="{{asset('front/images/fac.png')}}" alt="chat" /></span></a>
    <a href=""><span><img src="{{asset('front/images/1_Twitter3_colored_svg-64.webp')}} " alt="chat" /></span></a>
    <a href=""><span><img src="{{asset("front/images/icons/pinterest-svgrepo-com.svg")}}" alt="chat" /></span></a>
    <a href=""><span><img src="{{asset('front/images/icons/linkedin-linked-in-svgrepo-com.svg')}}" alt="chat" /></span></a>
</div>
        ...
        <div class="row">
            <div class="col-sm-12 col-md-8 col-lg-8 description">
                <div class="header">
                    ...
                    <p><span><a href="">المال والأعمال</a></span> / <span><a href="">إمساك الدفاتر</a></span></p>
                </div>
                <hr>
                <div class="rate">
                    ...
                    <div class="accordion-item">
                      <h2 class="accordion-header" id="flush-headingOne">
                        <button class="accordion-button collapsed" type="button" data-bs-toggle="collapse" data-bs-target="#flush-collapseOne" aria-expanded="false" aria-controls="flush-collapseOne">
                          <img src="{{asset('front/images/icons/speech-bubble-with-exclamation-mark-svgrepo-com.svg')}}" alt="">
                          <span>وصف الخدمة </span>
                        </button>
                      </h2>
                      <div id="flush-collapseOne" class="accordion-collapse collapse show" aria-labelledby="flush-headingOne" data-bs-parent="#accordionFlushExample">
                        <div class="accordion-body"><p>{{$data->description}}</p></div>
                      </div>
                    </div>
                    <div class="accordion-item">
                        ...
                        <div class="accordion-body">
                          ...
                          <form action="{{route('services.extra')}}" method="POST">
                            ...
                            <div class="extra">
                              ...
                              <div>
                                <input type="checkbox"  name="extra"  {{$status=='1' ? 'checked':''}}/>
              ...
              <div class="buy">
                <div class="dropdown">
                    ...
                    <button class="btn" type="button">
                        <a href="../payment.html">اشترى الان ب . {{$total}} USD</a>
                      </button>
                    @endauth
                    @guest
